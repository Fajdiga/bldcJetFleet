...
// Keep the byte-at-a-time serial ISR below FOC (5/6) and IMU DRDY (7).
// Default 115200 baud has ample byte-time margin at this priority.
#define HW_SERIAL_IRQ_PRIORITY	8U
