...
// IMU Interrupt (Data Ready) on PD2
#define LSM6DSV32X_INT_GPIO			GPIOD
#define LSM6DSV32X_INT_PIN			2
#define LSM6DSV32X_INT_EXTI_PORTSRC	EXTI_PortSourceGPIOD
#define LSM6DSV32X_INT_EXTI_PINSRC	EXTI_PinSource2
#define LSM6DSV32X_INT_EXTI_CH		EXTI2_IRQn
#define LSM6DSV32X_INT_EXTI_LINE	EXTI_Line2
#define LSM6DSV32X_INT_EXTI_ISR_VEC	EXTI2_IRQHandler
