...
#define IMU_DRDY_EXTI_CH		EXTI2_IRQn
#define IMU_DRDY_EXTI_LINE		EXTI_Line2
#define IMU_DRDY_EXTI_ISR_VEC	EXTI2_IRQHandler

// Only the LSM6DSV32X driver uses ISR-started SPI DMA. Other IMU drivers keep
// the generic DRDY-thread path.
...
#define MCCONF_FOC_PHASE_FILTER_ENABLE	false	// GaN stage: the modulation/bus model is more accurate
#endif
