...
void hw_init_gpio(void) {
	...
	// The generic IMU topology owns the SPI pins and PD2 data-ready EXTI setup.
	// They are initialized only when the IMU application starts.
}
...
void hw_setup_adc_channels(void) {
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_0, 6, ADC_SampleTime_15Cycles);    // dummy (rank 6)
